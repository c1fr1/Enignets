...
class ShaderProgram : GLResource {
	...
	operator fun set(type : Int, index : Int, value : Array<Vector2f>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Vector2d>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Vector2i>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Vector3f>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Vector3d>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Vector3i>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Vector4f>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Vector4d>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Vector4i>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix2f>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix3f>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix3x2f>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix4f>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix4x3f>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix2d>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix3d>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix3x2d>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix4d>) = this[type, index].set(value)
	...
	operator fun set(type : Int, index : Int, value : Array<Matrix4x3d>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Vector2f>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Vector2d>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Vector2i>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Vector3f>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Vector3d>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Vector3i>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Vector4f>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Vector4d>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Vector4i>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix2f>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix3f>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix3x2f>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix4f>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix4x3f>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix2d>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix3d>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix3x2d>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix4d>) = this[type, index].set(value)
	...
	operator fun set(type : ShaderType, index : Int, value : Array<Matrix4x3d>) = this[type, index].set(value)
